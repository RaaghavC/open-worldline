...
def read_image(path):
    ...
    with Image.open(path) as im:
        if im.mode!='RGB' or im.size!=(512,288):raise ValueError('Expected original RGB512x288 without resizing')
...
def main():
    ...
    r.update(experiment='Official Wan2.2 FP32 first-image codec reconstruction',original_model=False,external_pretrained_codec=True,
        ...
        input_transform='Original512x288 RGB PNG; pixel/127.5-1; no crop or resize',
