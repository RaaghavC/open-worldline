...
The [native CUDA reference](cuda_reference/README.md) completed on an A100 80 GB with byte-exact upstream model, attention, VAE and solver sources and original FP32 parameters. The [initial pair](cuda_reference/results/a100-pair-v1/README.md) completed in 243.19 seconds; future guided velocity differed from the streamed CPU reference by 2.294% of that reference's RMS. The [17-frame clip](cuda_reference/results/a100-clip50-v1/README.md) completed all 100 predictions and 50 solver steps in 476.44 seconds including loading and decoding. Severe colored distortions remain in the generated frames. This is a completed external-model diagnostic with failed visual quality, not an original-model advance. The [cloud result](../../docs/cloud-gpu-diagnostic-results-2026-09-07.md) includes confirmed instance deletion.
