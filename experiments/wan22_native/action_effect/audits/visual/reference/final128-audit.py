...
PREP = BASE / 'work/wan22-action-cuda-final128-visual-prepared-v1'
BASELINE = BASE / 'work/wan22-spatial-recovered-final-v1/recovered/spatial-results/clip-spatial-run-v1'
REVIEW = BASE / 'work/wan22-action-cuda-final128-eval-independent-review-v1/report.json'
PLAN_REVIEW = BASE / 'work/wan22-action-cuda-final128-actual-plan-review-v1/report.json'
PLAN_SHA = '6a00ce5db2b3858dd23a616beadbf774fb8b157efbc26edd8a969bde501bed3b'
REVIEW_SHA = '0b866edca7b812a7e75d582db708e5be719ea1523a1a7944924a981371700d1e'
PLAN_REVIEW_SHA = '06c44e84a308e5d7b8f99ce8a0d157a28670e9d7d0af27263993b63035cdbd4e'
...
CPU_SHA = '6e594717b809fa919bde463e29eb7823a6ac20d59361b35815e857b4e43bcc16'
...
def check_training_binding(plan, completed, training_sources):
    """Bind the final checkpoint to the independently audited 128-update run."""
    need(plan['schema']=='worldline-action-cuda-final128-visual-pair-v1'
         and plan['scope']=='final128-matched-wait-interact-visual-pair'
    ...
    need(completed['schema']=='worldline-action-cuda-fixed128-actual-independent-v1'
...
def audit(root, recovery, baseline, out):
    ...
    report={'schema':'worldline-action-cuda-final128-visual-actual-independent-v1','status':'running',
...
if __name__=='__main__':
    ...
    audit(source_root,args.recovery_verified.resolve(),args.baseline_root.resolve(),output)
