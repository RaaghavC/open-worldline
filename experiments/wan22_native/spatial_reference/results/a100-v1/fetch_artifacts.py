"""Download or verify pinned public spatial artifacts without a provider account."""
import argparse
import hashlib
import io
import json
...
def verify_index(index, metadata):
    require(index.get('schema') == 'worldline-spatial-recovery-v1', 'Unknown recovery index')
