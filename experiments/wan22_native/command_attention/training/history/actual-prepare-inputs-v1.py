...
sys.path[:0]=[str(ROOT/'outputs/open-worldline'),str(HERE.parent/'command-attention-controller-v1'),str(HERE.parent/'factorial-intermediate-training-v1')]
...
if __name__=='__main__':
    ...
    print(json.dumps(prepare(a.original,a.output)))
