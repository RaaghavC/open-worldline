...
from vendor.wan21.layers.attention import attention
from vendor.wan21.layers.norm import WanRMSNorm
...
class WanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        """
        from vendor.wan21.layers.rope import rope_apply
        ...
        if prope_enabled:
            from vendor.common.prope import prope_qkv
