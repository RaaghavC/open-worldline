...
A [different controller and training setup](experiments/wan22_native/command_attention/README.md) adds command-controlled attention across six blocks and direct camera-contrast training. Its [512-update A100 run and saved-result audit](experiments/wan22_native/command_attention/training/results/a100-v1/README.md) passed. Fixed-noise latent door comparisons improved, while camera response remained weak. Its generated-video evaluation is pending; the training result does not demonstrate visible control.
